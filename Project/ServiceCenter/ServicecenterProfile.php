...
$selquery = "SELECT * FROM tbl_servicecenter u 
              INNER JOIN tbl_place p ON u.place_id = p.place_id 
              INNER JOIN tbl_district d ON p.district_id = d.district_id 
              WHERE servicecenter_id = '" . $_SESSION['sid'] . "'";
...
<div class="profile">
    ...
    <div class="profile-header">
        <img src="../Assets/Files/ServicecenterDocs/<?php echo $data["servicecenter_photo"]; ?>" alt="Service Center Photo">
    </div>
    <div class="profile-info">
        <p><label>Name:</label> <?php echo $data["servicecenter_name"]; ?></p>
        <p><label>Email:</label> <?php echo $data["servicecenter_email"]; ?></p>
        <p><label>Contact:</label> <?php echo $data["servicecenter_contact"]; ?></p>
        <p><label>Address:</label> <?php echo $data["servicecenter_address"]; ?></p>
