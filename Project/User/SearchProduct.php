        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <ul class="list-group">
                        <?php                           
						 $selCat = "SELECT * from tbl_company";
                        ...
                        <li class="list-group-item">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" onclick="changeSub(),productCheck()" class="form-check-input product_check" value="<?php echo $row["company_id"]; ?>" id="company"><?php echo $row["company_name"]; ?>
                                </label>
                            </div>
                        </li>
                        <?php
                    ...
                    <br />
                    <h6 class="text-info"> Select Phone</h6>
...
function changeSub()
            {
                var cat = get_filter_text('company');
                if (cat.length !== 0)
                {
                    $.ajax({
                        url: "../Assets/Ajax/AjaxPhone.php?did=" + cat,
            ...
            function productCheck(){
                    ...
                    var action = 'data';
                    var company = get_filter_text('company');
                    ...
                    $.ajax({
                        url: "../Assets/Ajax/AjaxSearchProduct.php?action=" + action +"&company=" + company+"&mobile=" + mobile+"&name=" + name ,
                        success: function(response) {
