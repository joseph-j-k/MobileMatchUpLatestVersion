...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2024 at 10:24 AM
...
(5, 'December 27 2024, 10:20 AM', 2, 1, 'hi iwanto buy this phone'),
(6, 'December 27 2024, 10:22 AM', 1, 2, 'okk');
...
(1, 2, 1, 'okk', '2024-12-27 10:22:18', 'USER');
...
(4, 'Vivo', 'vivo@gmail.com', 'vivo', 'vivo-company.png', '8848951122', 'Kappad P.O Kozhikode', 24, 'vivo-company.png', 1);
...
(5, 'Redmi 13C 5g', 9999, 'Redmi', 3),
(6, 'Redmi A45G', 8984, 'Redmi', 3),
(10, 'Iphone 14 Pro ', 119900, 'Iphone', 2),
(11, 'SAMSUNG Galaxy S24 Ultra 5G', 102999, 'Samsung', 1),
(12, 'Vivo T3 Lite 5G', 10499, 'Vivo', 4),
(13, 'Vivo  X200 Pro 5G', 94999, 'Vivo', 4),
(14, 'Vivo T3 Ultra', 36000, 'Vivo', 4),
(16, 'Iphone 13 Pro ', 169900, 'Iphone', 2);
...
(5, 'Redmi 13C 5g', 'Startrail green', '128GB +6GB', '6GB RAM', '128GB ROM', 'Octa Core|1 GHz', '50MP', '8MP', '6.74inch Big screen,Fine video experience', '5000mAh', 'maxresdefault.jpg', '', 5),
(6, 'Redmi A45G', 'Starry Black', '64GB', '4GB RAM', '64GB  ROM', 'Octa Core|2 GHz', '50MP', '8MP', '6.88 inch display', '5160 mAh', 'redmia4.avif', '', 6),
(8, 'Iphone 14 Pro ', 'Space Black', '128GB', '8GB', '128GB ROM', 'A16 Bionic chip 6 core Processor|Hexa core', '48MP+12MP+12MP', '12MP', '6.1 inch super Retina XDR Display', '4500mAH', '14pro.jpg', '', 10),
(9, 'SAMSUNG Galaxy S24 Ultra 5G', 'Titanium Black', '256Gb', '12GB', '256GB', 'Snapdragon 8 Gen 3|Octa core|3.39 GHz', '200MP+50MP+12MP+10MP', '12MP', '6.8inch Dynamic AMOLED 2X', '5000mAh', 's24.webp', '', 11),
(10, 'Vivo T3 Lite 5G', 'Vibrant green', '128 GB', '4GB RAM', '128GB ROM', 'Dimensity 6300|Octa core|2.4GHz', '50MP+2MP', '8MP', '6.56 inch LCD', '5000mAh', 'Vivo-T3-Lite-5G.webp', '', 12),
(11, 'Vivo  X200 Pro 5G', 'Cosmos black', '512GB', '16 GB', '512 GB', 'Dimensity 9400|Octa core|3.626 GHz', '50MP+50MP+200MP', '32MP', '6.78inch 1,5k+AMOLED', '6000mAH', 'vivo-x200.png', '', 13),
(12, 'Vivo T3 Ultra', 'Startrail green', '256Gb', '12GB', '256GB', 'Dimensity 9200+|Octa Core|3.35GHz', '50MP+8MP', '50MP', '6.8inch Dynamic AMOLED 2X', '5500mAh', 'vivo t3 ultra.jpeg', '', 14),
(13, 'Iphone 13 Pro ', 'Sierra Blue', '1 TB', '12GB', '1 TB', 'A15 Bionic chip|Hexa core', '12MP+12MP+12MP', '12MP', '6.1 inch super Retina XDR Display', '3095 mAh', 'iphone13pro img.webp', '', 16);
...
(2, '2024-12-27 12:15:58', 14, 'good', 'adarsh', '3');
...
(2, 'Mobilecare', 'mobilecare1818@gmail.com', 'redmi.jfif', 'mobilecare', 21, 1, 'redmi.jfif', 2147483647, 'munnar P.O idduki'),
(3, 'Samsungcare', 'samsung1818@gmail.com', 'samsung.jpg', 'samsung', 1, 1, 'samsung.jpg', 2147483647, 'muvattupuzha p.o ernakulam');
...
(3, 'Dispplay issue', 'Any display issue will repair', '5000', 2),
(4, 'Batter issue', 'Any Battery issue will repair', '2400', 2),
(5, 'Call issue', 'Any call issue will repair', '1000', 2),
(6, 'Battery Problems', 'battery charging problems', '4333', 3),
(7, 'Phone display issue', 'any phone display issue will sortout', '2345', 3);
...
(13, 120, '2024-12-27', 4),
(14, 50, '2024-12-27', 11),
(15, 120, '2024-12-27', 16),
(16, 500, '2024-12-27', 17);
...
(2, 'Redmi 13 c', 'a good phone with good perfomance', '12500', 'maxresdefault.jpg', 1);
...
(3, 'Ajin Benny', 'Male', '9945787778', 'ajinbenny1818@gmail.com', 'Ajin@123', 1, 'redmia4.avif', 'iphone13pro img.webp', 'Muvattupuzha P.O Ernakulam');
...
--
ALTER TABLE `tbl_buyusedphone`
  MODIFY `buyphone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tbl_mobiledetails`
  MODIFY `mobiledetails_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `tbl_usedphone`
  MODIFY `usedphone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
